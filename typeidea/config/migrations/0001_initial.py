    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_type', models.PositiveIntegerField(choices=[(1, 'HTML'), (2, '最新文章'), (3, '最热文章'), (4, '最近评论')], default=1)),
                ('status', models.PositiveIntegerField(choices=[(1, '展示'), (0, '隐藏')], default=1, verbose_name='状态')),
                ('content', models.CharField(blank=True, help_text='如果设置的不是HTML格式，可为空', max_length=500, verbose_name='内容')),
